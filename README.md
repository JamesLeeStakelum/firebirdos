...
**Contact:** [JamesLeeStakelum@Proton.me](mailto:JamesLeeStakelum@Proton.me)  
...
- **The Bank Problem** – Words like "bank" (financial institution vs. riverbank) collapse into single embeddings, causing retrieval errors. The Axiom Lexicon uses 1.7M distinct `meaning_id`s to eliminate polysemy.
...
*For the philosophical foundation, read the [Firebird Manifesto](docs/Firebird_Manifesto.pdf)*  
